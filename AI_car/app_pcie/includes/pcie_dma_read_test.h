...
#define PCI_GET_IMG						_IOWR(TYPE, 11, int)	// ioctl：获取图片数据
#define GPIO_OUT                        _IOWR(TYPE, 12, int) // 映射内核中的 case GPIO_OUT
#define GPIO_IN                         _IOWR(TYPE, 13, int) // 映射内核中的 case GPIO_IN
