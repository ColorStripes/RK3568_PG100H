...
#
# Generated by export_simulation on Sun Jun 21 22:03:54 +0800 2026
#
################################################################################
...
'-reset_run' switch to the './ov5640_clk.sh' script.

./ov5640_clk.sh -reset_run
...
./ov5640_clk.sh -noclean_files

For more information on the script, please type './ov5640_clk.sh -help'.
