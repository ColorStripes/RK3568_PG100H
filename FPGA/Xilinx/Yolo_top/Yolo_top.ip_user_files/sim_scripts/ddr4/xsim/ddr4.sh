...
simulate()
{
  xsim ddr4 -key {Behavioral:sim_1:Functional:ddr4} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_a5d6.protoinst" -protoinst "protoinst_files/npu_ddr.protoinst" -protoinst "protoinst_files/bd_c703.protoinst" -log simulate.log
}
