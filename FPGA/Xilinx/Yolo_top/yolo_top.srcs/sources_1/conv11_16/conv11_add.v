...
/////////////////////////////////读出上一次加和的结果////////////////////////////////
    ...
    generate
        for (genvar j = 0; j < CHA_PAR_OUT; j = j+1) begin
...
/////////////////////////////////bias处理////////////////////////////////
    ...
    generate
        for (genvar i = 0; i < CHA_PAR_OUT/BIAS_NUM; i = i+1) begin
            if(BIAS_NUM == 1) begin
...
////////////////////////////////scale是s1*s2/s3 这里是将q1*q2先变为f1*f2=f3 然后/s3 将f3变为q3定点数///////////////////////////////////////
    ...
    generate
        for (genvar i = 0; i < CHA_PAR_OUT; i = i + 1) begin: SCALE_S1_S2_S3
            scale_mul #(
...
////////////////////////////////q3 + b3  都是整数类型的///////////////////////////////////////
    ...
    generate
        for(genvar i = 0; i < CHA_PAR_OUT; i = i + 1) begin: Q3_B3_Z3
            always @(posedge clk) begin
...
////////////////////////////////Relu激活///////////////////////////////////////
    ...
    generate
        for(genvar i = 0; i < CHA_PAR_OUT; i = i + 1) begin: RELU
...
////////////////////////////////数据输出////////////////////////////////////////待修改
    ...
    generate
        for(genvar i = 0; i < CHA_PAR_OUT; i = i + 1) begin: OUT_PUT
...
////////////////////////////////////////////计算结束信号输出延迟//////////////////////////////////////////////////////
    ...
    //stride的时候会提前拉高一周期
    assign m_last= s_last_d[CALCULATE_DELAY-1] & calculate_last_d[CALCULATE_DELAY-1];
