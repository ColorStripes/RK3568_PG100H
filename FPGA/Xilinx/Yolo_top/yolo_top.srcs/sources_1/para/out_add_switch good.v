...
///////////////////////////////////////////
    ...
    wire  [AXI_ADDR_WIDTH-1 : 0] out_add_cmd_addr   ;
    wire  [AXI_DATA_WIDTH-1 : 0] out_add_cmd_len    ;
    wire                         out_add_cmd_valid  ;
    wire                         out_add_cmd_ready  ;
...
///////////////////////////
    ...
    assign out_add_cmd_addr = s_cmd_addr & {AXI_ADDR_WIDTH{start_para}};
    assign out_m_cmd_addr     = s_cmd_addr & {AXI_ADDR_WIDTH{start_m}};

    assign out_add_cmd_len = s_cmd_len & {AXI_DATA_WIDTH{start_para}};
    assign out_m_cmd_len     = s_cmd_len & {AXI_DATA_WIDTH{start_m}};

    assign out_add_cmd_valid = s_cmd_valid & {start_para};
    ...
    pipe_out_add_cmd(
        ...
        .up_valid(out_add_cmd_valid),
        .up_ready(out_add_cmd_ready),
        .data_in ({out_add_cmd_addr, out_add_cmd_len}),


        .down_valid(add_m_cmd_valid),
        .down_ready(add_m_cmd_ready),
        .data_out  ({add_m_cmd_addr, add_m_cmd_len})
    );
