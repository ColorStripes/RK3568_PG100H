...
///////////////////////////
    ...
    assign conv_m_cmd_addr = s_cmd_addr & {AXI_ADDR_WIDTH{start_para}};
    assign m_cmd_addr     = s_cmd_addr & {AXI_ADDR_WIDTH{start_m}};

    assign conv_m_cmd_len = s_cmd_len & {AXI_DATA_WIDTH{start_para}};
    assign m_cmd_len     = s_cmd_len & {AXI_DATA_WIDTH{start_m}};

    assign conv_m_cmd_valid = s_cmd_valid & {start_para};
    ...
    assign conv_m_valid = out_conv_valid;
    assign out_conv_ready = conv_m_ready;
    assign conv_m_last  = out_conv_last;
    assign conv_m_data  = out_conv_data;
    ...
    assign out_m_ready = m_ready;
    assign m_last    = out_m_last;
    assign m_data    = out_m_data;
