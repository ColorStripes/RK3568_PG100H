...
--               F:/FPGA/Yolo_top/Yolo_top.srcs/sources_1/ip/clk_wiz_ddr/clk_wiz_ddr_sim_netlist.vhdl
-- Design      : clk_wiz_ddr
...
entity clk_wiz_ddr_clk_wiz_ddr_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of clk_wiz_ddr_clk_wiz_ddr_clk_wiz : entity is "clk_wiz_ddr_clk_wiz";
end clk_wiz_ddr_clk_wiz_ddr_clk_wiz;

architecture STRUCTURE of clk_wiz_ddr_clk_wiz_ddr_clk_wiz is
  signal clk_in1_clk_wiz_ddr : STD_LOGIC;
  signal clk_out1_clk_wiz_ddr : STD_LOGIC;
  signal clk_out2_clk_wiz_ddr : STD_LOGIC;
...
plle4_adv_inst: unisim.vcomponents.PLLE4_ADV
    generic map(
      ...
      CLKIN => clk_in1_clk_wiz_ddr,
      CLKOUT0 => clk_out1_clk_wiz_ddr,
      CLKOUT0B => NLW_plle4_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_out2_clk_wiz_ddr,
...
entity clk_wiz_ddr is
  ...
  attribute NotValidForBitStream of clk_wiz_ddr : entity is true;
end clk_wiz_ddr;

architecture STRUCTURE of clk_wiz_ddr is
begin
inst: entity work.clk_wiz_ddr_clk_wiz_ddr_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2
