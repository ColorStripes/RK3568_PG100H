...
(
    ...
    (*mark_debug = "true"*)input          data_last    ,
    (*mark_debug = "true"*)output         data_req     ,               //向conv33_in_ctrl请求三行数据
...
////////////////////////////////// 计算所需数据请求 /////////////////////////////////////////////
    ...
    (*mark_debug = "true"*)reg [1 : 0] weight_cnt;
    always @(posedge clk) begin
        if(rst) begin
            weight_cnt <= 2'd0;
        end
    ...
    (*mark_debug = "true"*)reg [1 : 0] bias_cnt;
    always @(posedge clk) begin
        if(rst) begin
            bias_cnt <= 2'd0;
        end
...
////////////////////////////////// 行列相关 /////////////////////////////////////////////  
    //行数计数器
    (*mark_debug = "true"*)reg [ROW_WIDTH : 0] row_num_r;
    always @(posedge clk) begin
        if(rst) begin
            row_num_r <= 0;
        end
