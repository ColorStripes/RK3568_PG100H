...
(
    ...
    //out的输出
    (*mark_debug = "true"*)output [DATA_WIDTH_OUT-1 : 0]   out_m_data  ,
    (*mark_debug = "true"*)output                          out_m_last  ,
    (*mark_debug = "true"*)output                          out_m_valid ,
    (*mark_debug = "true"*)input                           out_m_ready , 

    (*mark_debug = "true"*)output [AXI_ADDR_WIDTH-1 : 0]   out_m_cmd_addr  ,
    (*mark_debug = "true"*)output [AXI_DATA_WIDTH-1 : 0]   out_m_cmd_len   ,
    (*mark_debug = "true"*)output                          out_m_cmd_valid ,
    (*mark_debug = "true"*)input                           out_m_cmd_ready ,

    (*mark_debug = "true"*)output                          out_calculate_end         ,//////////////////
    (*mark_debug = "true"*)input                           out_calculate_end_receive ,
...
///////////////////////////////////////////////////////////////////
    ...
    //用于算子的瞬时start
    (*mark_debug = "true"*)reg [6 : 0] start_d;
...
// ///////////////////////////////////////////
//     .conv_weight1_data (conv_weight1_data )     ,
//     .conv_weight1_valid(conv_weight1_valid)     ,
//     .conv_weight1_last (conv_weight1_last )     ,
//     .conv_weight1_ready(conv_weight1_ready)     ,

//     .conv_weight1_cmd_addr (conv_weight1_cmd_addr ) ,
//     .conv_weight1_cmd_len  (conv_weight1_cmd_len  ) ,
//     .conv_weight1_cmd_valid(conv_weight1_cmd_valid) ,
//     .conv_weight1_cmd_ready(conv_weight1_cmd_ready) ,


//     .conv_weight2_data (conv_weight2_data )     ,
//     .conv_weight2_valid(conv_weight2_valid)     ,
//     .conv_weight2_last (conv_weight2_last )     ,
//     .conv_weight2_ready(conv_weight2_ready)     ,

//     .conv_weight2_cmd_addr (conv_weight2_cmd_addr ) ,
//     .conv_weight2_cmd_len  (conv_weight2_cmd_len  ) ,
//     .conv_weight2_cmd_valid(conv_weight2_cmd_valid) ,
//     .conv_weight2_cmd_ready(conv_weight2_cmd_ready) 
...
///////////////////////////////////////主算子//////////////////////////////////////////////////////
    ...
    //conv的输出
    (*mark_debug = "true"*)wire [`CONV_CHA_PAR_OUT*INT-1 : 0]   conv_m_data  ;
    (*mark_debug = "true"*)wire                                 conv_m_last  ;
    (*mark_debug = "true"*)wire                                 conv_m_valid ;
    (*mark_debug = "true"*)wire                                 conv_m_req   ; 
conv_top #(
    .AXI_DATA_WIDTH(AXI_DATA_WIDTH),
    .AXI_ADDR_WIDTH(AXI_ADDR_WIDTH),
    //并行度//
...
//     .s_addr_1  (s_addr_1) ,            //特征图数据输入地址
//     .s_data_1  (cat_add_s_data_1 )    ,
//     .s_valid_1 (cat_add_s_valid_1)    ,
//     .s_last_1  (cat_add_s_last_1 )    ,
//     .s_ready_1 (cat_add_s_ready_1)    ,
...
//     .s_cmd_addr_1 (cat_add_s_cmd_addr_1 ),
//     .s_cmd_len_1  (cat_add_s_cmd_len_1  ),
//     .s_cmd_valid_1(cat_add_s_cmd_valid_1),
//     .s_cmd_ready_1(cat_add_s_cmd_ready_1),
...
// //     .s_addr_1  (s_addr_1) ,            //特征图数据输入地址
// //     .s_data_1  (cat_add_s_data_0 )    ,
// //     .s_valid_1 (cat_add_s_valid_0)    ,
// //     .s_last_1  (cat_add_s_last_0 )    ,
// //     .s_ready_1 (cat_add_s_ready_0)    ,


// //     //in_buf的命令接口
// //     .s_cmd_addr_1 (cat_add_s_cmd_addr_0 ) ,
// //     .s_cmd_len_1  (cat_add_s_cmd_len_0  ) ,
// //     .s_cmd_valid_1(cat_add_s_cmd_valid_0) ,
// //     .s_cmd_ready_1(cat_add_s_cmd_ready_0) ,


// //     .s_addr_0  (s_addr_0) ,            //特征图数据输入地址
// //     .s_data_0  (cat_add_s_data_1 )    ,
// //     .s_valid_0 (cat_add_s_valid_1)    ,
// //     .s_last_0  (cat_add_s_last_1 )    ,
// //     .s_ready_0 (cat_add_s_ready_1)    ,


// //     .s_cmd_addr_0 (cat_add_s_cmd_addr_1 ),
// //     .s_cmd_len_0  (cat_add_s_cmd_len_1  ),
// //     .s_cmd_valid_0(cat_add_s_cmd_valid_1),
// //     .s_cmd_ready_0(cat_add_s_cmd_ready_1),
// // //////////////////////////////////////////////////////
...
focus_top_inst(
    ...
    (*mark_debug = "true"*)wire [DATA_WIDTH_OUT-1 : 0] out_buf_data ;
    (*mark_debug = "true"*)wire                        out_buf_last ;
    (*mark_debug = "true"*)wire                        out_buf_valid;
    (*mark_debug = "true"*)wire                        out_buf_ready;

    (*mark_debug = "true"*)wire [AXI_ADDR_WIDTH-1 : 0] out_buf_cmd_addr ;
    (*mark_debug = "true"*)wire [AXI_DATA_WIDTH-1 : 0] out_buf_cmd_len  ;
    (*mark_debug = "true"*)wire                        out_buf_cmd_valid;
    (*mark_debug = "true"*)wire                        out_buf_cmd_ready;
