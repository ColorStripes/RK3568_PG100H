...
(
    ...
    input  [LEN_WIDTH : 0]                    in_col_channel_num  , //col_num = col * channel
...
conv_in_buf_ctrl_inst (
    .clk(clk)               ,
    .rst(rst)               ,

    .start(start)           ,//起始信号
    .base_addr(base_addr)   ,//读取内存的起始基地址
    .in_col_channel_num(in_col_channel_num)       ,//这是需要读取一行的总字节数 col_num = col * channel
