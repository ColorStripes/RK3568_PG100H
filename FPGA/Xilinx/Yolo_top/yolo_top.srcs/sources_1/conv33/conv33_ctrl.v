...
///////////////////////////////////////// 计算信号相关(发送到ADD计算单元的信号) ///////////////////////////////////////////////////
    ...
    //3拍数据延迟 + 4拍乘法器延迟 + 2拍3*3点加法延迟 + $clog2(CHA_PAR_IN)拍输入并行通道相加延迟
    ...
    assign calculate_first = calculate_first_d[DELAY-1] & calculate_first_d[(DELAY-2)-1];
    assign calculate_last  = calculate_last_d[DELAY-1] & calculate_last_d[(DELAY-2)-1];
