...
///////////////////////////////////////// 计算所需数据的算子级别寄存器 /////////////////////////////////
    ...
    reg  [BIAS_LEN_WIDTH : 0]          bias_len_reg          ;
...
weight_bias(
    ...
    .weight_len(weight_len_reg),              //这是向DMA请求weight的部分字节数 包括bias   ===》 ci*co*9
    .bias_len(bias_len_reg),				  //bias字节数 包括  所有bias字节数 + 一次weight_len    
