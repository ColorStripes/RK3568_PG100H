...
module udp2npu_data #(
    parameter AXI_DATA_WIDTH    = 32,
            ...
            //   NPU_LAYER = (DEBUG == 1) ? 1 : 88,
              LAYER_WIDTH = (NPU_LAYER == 1) ? 1 : $clog2(NPU_LAYER)
)(
    input clk,
    input rst,
    ...
    always @(*) begin
        case(state)
            ...
            //向PC发送计算结束信号
            NPU_END:begin
                if(npu_layer != NPU_LAYER-1) begin
                    next_state = IDLE;
                end
...
/////////////////////////////////////////////////////////////////////////////////
    ...
    assign m_eth_axis_data  = (state == NPU_END) ? 8'd4 : s_npu_axis_data;                                                                                                             
    assign m_eth_axis_valid = (state == NPU_END) ? (npu_layer == NPU_LAYER-1) : s_npu_axis_valid;
