...
proc create_root_design { parentCell } {
  ...
  set read_cmd_addr_3 [ create_bd_port -dir I -from 31 -to 0 read_cmd_addr_3 ]
  set read_cmd_addr_4 [ create_bd_port -dir I -from 31 -to 0 read_cmd_addr_4 ]
  set read_cmd_addr_5 [ create_bd_port -dir I -from 31 -to 0 read_cmd_addr_5 ]
  ...
  set read_cmd_len_3 [ create_bd_port -dir I -from 31 -to 0 read_cmd_len_3 ]
  set read_cmd_len_4 [ create_bd_port -dir I -from 31 -to 0 read_cmd_len_4 ]
  set read_cmd_len_5 [ create_bd_port -dir I -from 31 -to 0 read_cmd_len_5 ]
  ...
  set read_cmd_ready_3 [ create_bd_port -dir O read_cmd_ready_3 ]
  set read_cmd_ready_4 [ create_bd_port -dir O read_cmd_ready_4 ]
  set read_cmd_ready_5 [ create_bd_port -dir O read_cmd_ready_5 ]
  ...
  set read_cmd_valid_3 [ create_bd_port -dir I read_cmd_valid_3 ]
  set read_cmd_valid_4 [ create_bd_port -dir I read_cmd_valid_4 ]
  set read_cmd_valid_5 [ create_bd_port -dir I read_cmd_valid_5 ]
  ...
  set read_data_3 [ create_bd_port -dir O -from 127 -to 0 read_data_3 ]
  set read_data_4 [ create_bd_port -dir O -from 127 -to 0 read_data_4 ]
  set read_data_5 [ create_bd_port -dir O -from 127 -to 0 read_data_5 ]
  ...
  set read_keep_3 [ create_bd_port -dir O -from 15 -to 0 read_keep_3 ]
  set read_keep_4 [ create_bd_port -dir O -from 15 -to 0 read_keep_4 ]
  set read_keep_5 [ create_bd_port -dir O -from 15 -to 0 read_keep_5 ]
  ...
  set read_last_3 [ create_bd_port -dir O read_last_3 ]
  set read_last_4 [ create_bd_port -dir O read_last_4 ]
  set read_last_5 [ create_bd_port -dir O read_last_5 ]
  ...
  set read_ready_3 [ create_bd_port -dir I read_ready_3 ]
  set read_ready_4 [ create_bd_port -dir I read_ready_4 ]
  set read_ready_5 [ create_bd_port -dir I read_ready_5 ]
  ...
  set read_valid_3 [ create_bd_port -dir O read_valid_3 ]
  set read_valid_4 [ create_bd_port -dir O read_valid_4 ]
  set read_valid_5 [ create_bd_port -dir O read_valid_5 ]
  ...
  # Create instance: axi_datamover_4, and set properties
  set axi_datamover_4 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_datamover:5.1 axi_datamover_4 ]
  set_property -dict [ list \
   CONFIG.c_dummy {1} \
   CONFIG.c_enable_cache_user {false} \
   CONFIG.c_enable_s2mm {0} \
  ...
  # Create instance: axi_datamover_5, and set properties
  set axi_datamover_5 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_datamover:5.1 axi_datamover_5 ]
  set_property -dict [ list \
   CONFIG.c_dummy {1} \
   CONFIG.c_enable_cache_user {false} \
   CONFIG.c_enable_s2mm {0} \
   CONFIG.c_include_mm2s_dre {true} \
   CONFIG.c_m_axi_mm2s_arid {5} \
   CONFIG.c_m_axi_mm2s_data_width {128} \
   CONFIG.c_m_axis_mm2s_tdata_width {128} \
   CONFIG.c_mm2s_btt_used {23} \
   CONFIG.c_mm2s_burst_size {64} \
  ...
  # Create instance: cmd_mm2s_3, and set properties
  set cmd_mm2s_3 [ create_bd_cell -type ip -vlnv xilinx.com:user:cmd_mm2s:2.0 cmd_mm2s_3 ]

  # Create instance: cmd_mm2s_4, and set properties
  set cmd_mm2s_4 [ create_bd_cell -type ip -vlnv xilinx.com:user:cmd_mm2s:2.0 cmd_mm2s_4 ]

  # Create instance: cmd_mm2s_5, and set properties
  set cmd_mm2s_5 [ create_bd_cell -type ip -vlnv xilinx.com:user:cmd_mm2s:2.0 cmd_mm2s_5 ]
  ...
  connect_bd_intf_net -intf_net axi_datamover_2_M_AXI_MM2S [get_bd_intf_pins axi_datamover_2/M_AXI_MM2S] [get_bd_intf_pins axi_interconnect_0/S02_AXI]
  connect_bd_intf_net -intf_net axi_datamover_3_M_AXIS_MM2S [get_bd_intf_pins axi_datamover_3/M_AXIS_MM2S] [get_bd_intf_pins cmd_mm2s_3/m_axis_mm2s]
  connect_bd_intf_net -intf_net axi_datamover_3_M_AXIS_MM2S_STS [get_bd_intf_pins axi_datamover_3/M_AXIS_MM2S_STS] [get_bd_intf_pins cmd_mm2s_3/m_axis_mm2s_sts]
  connect_bd_intf_net -intf_net axi_datamover_3_M_AXI_MM2S [get_bd_intf_pins axi_datamover_3/M_AXI_MM2S] [get_bd_intf_pins axi_interconnect_0/S03_AXI]
  connect_bd_intf_net -intf_net axi_datamover_4_M_AXIS_MM2S [get_bd_intf_pins axi_datamover_4/M_AXIS_MM2S] [get_bd_intf_pins cmd_mm2s_4/m_axis_mm2s]
  connect_bd_intf_net -intf_net axi_datamover_4_M_AXIS_MM2S_STS [get_bd_intf_pins axi_datamover_4/M_AXIS_MM2S_STS] [get_bd_intf_pins cmd_mm2s_4/m_axis_mm2s_sts]
  connect_bd_intf_net -intf_net axi_datamover_4_M_AXI_MM2S [get_bd_intf_pins axi_datamover_4/M_AXI_MM2S] [get_bd_intf_pins axi_interconnect_0/S04_AXI]
  connect_bd_intf_net -intf_net axi_datamover_5_M_AXIS_MM2S [get_bd_intf_pins axi_datamover_5/M_AXIS_MM2S] [get_bd_intf_pins cmd_mm2s_5/m_axis_mm2s]
  connect_bd_intf_net -intf_net axi_datamover_5_M_AXIS_MM2S_STS [get_bd_intf_pins axi_datamover_5/M_AXIS_MM2S_STS] [get_bd_intf_pins cmd_mm2s_5/m_axis_mm2s_sts]
  connect_bd_intf_net -intf_net axi_datamover_5_M_AXI_MM2S [get_bd_intf_pins axi_datamover_5/M_AXI_MM2S] [get_bd_intf_pins axi_interconnect_0/S05_AXI]
  ...
  connect_bd_intf_net -intf_net cmd_mm2s_3_s_axis_mm2s_cmd [get_bd_intf_pins axi_datamover_3/S_AXIS_MM2S_CMD] [get_bd_intf_pins cmd_mm2s_3/s_axis_mm2s_cmd]
  connect_bd_intf_net -intf_net cmd_mm2s_4_s_axis_mm2s_cmd [get_bd_intf_pins axi_datamover_4/S_AXIS_MM2S_CMD] [get_bd_intf_pins cmd_mm2s_4/s_axis_mm2s_cmd]
  connect_bd_intf_net -intf_net cmd_mm2s_5_s_axis_mm2s_cmd [get_bd_intf_pins axi_datamover_5/S_AXIS_MM2S_CMD] [get_bd_intf_pins cmd_mm2s_5/s_axis_mm2s_cmd]
  ...
  connect_bd_net -net cmd_mm2s_3_read_cmd_ready [get_bd_ports read_cmd_ready_3] [get_bd_pins cmd_mm2s_3/read_cmd_ready]
  connect_bd_net -net cmd_mm2s_3_read_data [get_bd_ports read_data_3] [get_bd_pins cmd_mm2s_3/read_data]
  connect_bd_net -net cmd_mm2s_3_read_keep [get_bd_ports read_keep_3] [get_bd_pins cmd_mm2s_3/read_keep]
  connect_bd_net -net cmd_mm2s_3_read_last [get_bd_ports read_last_3] [get_bd_pins cmd_mm2s_3/read_last]
  connect_bd_net -net cmd_mm2s_3_read_valid [get_bd_ports read_valid_3] [get_bd_pins cmd_mm2s_3/read_valid]
  connect_bd_net -net cmd_mm2s_4_read_cmd_ready [get_bd_ports read_cmd_ready_4] [get_bd_pins cmd_mm2s_4/read_cmd_ready]
  connect_bd_net -net cmd_mm2s_4_read_data [get_bd_ports read_data_4] [get_bd_pins cmd_mm2s_4/read_data]
  connect_bd_net -net cmd_mm2s_4_read_keep [get_bd_ports read_keep_4] [get_bd_pins cmd_mm2s_4/read_keep]
  connect_bd_net -net cmd_mm2s_4_read_last [get_bd_ports read_last_4] [get_bd_pins cmd_mm2s_4/read_last]
  connect_bd_net -net cmd_mm2s_4_read_valid [get_bd_ports read_valid_4] [get_bd_pins cmd_mm2s_4/read_valid]
  connect_bd_net -net cmd_mm2s_5_read_cmd_ready [get_bd_ports read_cmd_ready_5] [get_bd_pins cmd_mm2s_5/read_cmd_ready]
  connect_bd_net -net cmd_mm2s_5_read_data [get_bd_ports read_data_5] [get_bd_pins cmd_mm2s_5/read_data]
  connect_bd_net -net cmd_mm2s_5_read_keep [get_bd_ports read_keep_5] [get_bd_pins cmd_mm2s_5/read_keep]
  connect_bd_net -net cmd_mm2s_5_read_last [get_bd_ports read_last_5] [get_bd_pins cmd_mm2s_5/read_last]
  connect_bd_net -net cmd_mm2s_5_read_valid [get_bd_ports read_valid_5] [get_bd_pins cmd_mm2s_5/read_valid]
  ...
  connect_bd_net -net ddr4_0_addn_ui_clkout1 [get_bd_ports clk] [get_bd_pins axi_datamover_0/m_axi_mm2s_aclk] [get_bd_pins axi_datamover_0/m_axi_s2mm_aclk] [get_bd_pins axi_datamover_0/m_axis_mm2s_cmdsts_aclk] [get_bd_pins axi_datamover_0/m_axis_s2mm_cmdsts_awclk] [get_bd_pins axi_datamover_1/m_axi_mm2s_aclk] [get_bd_pins axi_datamover_1/m_axi_s2mm_aclk] [get_bd_pins axi_datamover_1/m_axis_mm2s_cmdsts_aclk] [get_bd_pins axi_datamover_1/m_axis_s2mm_cmdsts_awclk] [get_bd_pins axi_datamover_2/m_axi_mm2s_aclk] [get_bd_pins axi_datamover_2/m_axis_mm2s_cmdsts_aclk] [get_bd_pins axi_datamover_3/m_axi_mm2s_aclk] [get_bd_pins axi_datamover_3/m_axis_mm2s_cmdsts_aclk] [get_bd_pins axi_datamover_4/m_axi_mm2s_aclk] [get_bd_pins axi_datamover_4/m_axis_mm2s_cmdsts_aclk] [get_bd_pins axi_datamover_5/m_axi_mm2s_aclk] [get_bd_pins axi_datamover_5/m_axis_mm2s_cmdsts_aclk] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_0/S02_ACLK] [get_bd_pins axi_interconnect_0/S03_ACLK] [get_bd_pins axi_interconnect_0/S04_ACLK] [get_bd_pins axi_interconnect_0/S05_ACLK] [get_bd_pins cmd_mm2s_0/clk] [get_bd_pins cmd_mm2s_1/clk] [get_bd_pins cmd_mm2s_2/clk] [get_bd_pins cmd_mm2s_3/clk] [get_bd_pins cmd_mm2s_4/clk] [get_bd_pins cmd_mm2s_5/clk] [get_bd_pins cmd_s2mm_0/clk] [get_bd_pins cmd_s2mm_1/clk] [get_bd_pins ddr4_0/addn_ui_clkout1] [get_bd_pins rst_250M/slowest_sync_clk]
  ...
  connect_bd_net -net ddr4_0_c0_ddr4_ui_clk_sync_rst [get_bd_pins ddr4_0/c0_ddr4_ui_clk_sync_rst] [get_bd_pins rst_250M/ext_reset_in] [get_bd_pins rst_ddr4_0_300M/ext_reset_in]
  ...
  connect_bd_net -net read_cmd_addr_3_1 [get_bd_ports read_cmd_addr_3] [get_bd_pins cmd_mm2s_3/read_cmd_addr]
  connect_bd_net -net read_cmd_addr_4_1 [get_bd_ports read_cmd_addr_4] [get_bd_pins cmd_mm2s_4/read_cmd_addr]
  connect_bd_net -net read_cmd_addr_5_1 [get_bd_ports read_cmd_addr_5] [get_bd_pins cmd_mm2s_5/read_cmd_addr]
  ...
  connect_bd_net -net read_cmd_len_3_1 [get_bd_ports read_cmd_len_3] [get_bd_pins cmd_mm2s_3/read_cmd_len]
  connect_bd_net -net read_cmd_len_4_1 [get_bd_ports read_cmd_len_4] [get_bd_pins cmd_mm2s_4/read_cmd_len]
  connect_bd_net -net read_cmd_len_5_1 [get_bd_ports read_cmd_len_5] [get_bd_pins cmd_mm2s_5/read_cmd_len]
  ...
  connect_bd_net -net read_cmd_valid_3_1 [get_bd_ports read_cmd_valid_3] [get_bd_pins cmd_mm2s_3/read_cmd_valid]
  connect_bd_net -net read_cmd_valid_4_1 [get_bd_ports read_cmd_valid_4] [get_bd_pins cmd_mm2s_4/read_cmd_valid]
  connect_bd_net -net read_cmd_valid_5_1 [get_bd_ports read_cmd_valid_5] [get_bd_pins cmd_mm2s_5/read_cmd_valid]
  ...
  connect_bd_net -net read_ready_3_1 [get_bd_ports read_ready_3] [get_bd_pins cmd_mm2s_3/read_ready]
  connect_bd_net -net read_ready_4_1 [get_bd_ports read_ready_4] [get_bd_pins cmd_mm2s_4/read_ready]
  connect_bd_net -net read_ready_5_1 [get_bd_ports read_ready_5] [get_bd_pins cmd_mm2s_5/read_ready]
  connect_bd_net -net reset_rtl_0_1 [get_bd_ports sys_rst] [get_bd_pins ddr4_0/sys_rst]
  connect_bd_net -net rst_250M_peripheral_aresetn [get_bd_pins axi_datamover_0/m_axi_mm2s_aresetn] [get_bd_pins axi_datamover_0/m_axi_s2mm_aresetn] [get_bd_pins axi_datamover_0/m_axis_mm2s_cmdsts_aresetn] [get_bd_pins axi_datamover_0/m_axis_s2mm_cmdsts_aresetn] [get_bd_pins axi_datamover_1/m_axi_mm2s_aresetn] [get_bd_pins axi_datamover_1/m_axi_s2mm_aresetn] [get_bd_pins axi_datamover_1/m_axis_mm2s_cmdsts_aresetn] [get_bd_pins axi_datamover_1/m_axis_s2mm_cmdsts_aresetn] [get_bd_pins axi_datamover_2/m_axi_mm2s_aresetn] [get_bd_pins axi_datamover_2/m_axis_mm2s_cmdsts_aresetn] [get_bd_pins axi_datamover_3/m_axi_mm2s_aresetn] [get_bd_pins axi_datamover_3/m_axis_mm2s_cmdsts_aresetn] [get_bd_pins axi_datamover_4/m_axi_mm2s_aresetn] [get_bd_pins axi_datamover_4/m_axis_mm2s_cmdsts_aresetn] [get_bd_pins axi_datamover_5/m_axi_mm2s_aresetn] [get_bd_pins axi_datamover_5/m_axis_mm2s_cmdsts_aresetn] [get_bd_pins rst_250M/peripheral_aresetn]
  connect_bd_net -net rst_250M_peripheral_reset [get_bd_ports rst] [get_bd_pins cmd_mm2s_0/rst] [get_bd_pins cmd_mm2s_1/rst] [get_bd_pins cmd_mm2s_2/rst] [get_bd_pins cmd_mm2s_3/rst] [get_bd_pins cmd_mm2s_4/rst] [get_bd_pins cmd_mm2s_5/rst] [get_bd_pins cmd_s2mm_0/rst] [get_bd_pins cmd_s2mm_1/rst] [get_bd_pins rst_250M/peripheral_reset]
  connect_bd_net -net rst_ddr4_0_250M1_interconnect_aresetn [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_0/S02_ARESETN] [get_bd_pins axi_interconnect_0/S03_ARESETN] [get_bd_pins axi_interconnect_0/S04_ARESETN] [get_bd_pins axi_interconnect_0/S05_ARESETN] [get_bd_pins rst_250M/interconnect_aresetn]
  ...
  assign_bd_address -offset 0x80000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_datamover_2/Data_MM2S] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
  assign_bd_address -offset 0x80000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_datamover_3/Data_MM2S] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
  assign_bd_address -offset 0x80000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_datamover_4/Data_MM2S] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
  assign_bd_address -offset 0x80000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_datamover_5/Data_MM2S] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
