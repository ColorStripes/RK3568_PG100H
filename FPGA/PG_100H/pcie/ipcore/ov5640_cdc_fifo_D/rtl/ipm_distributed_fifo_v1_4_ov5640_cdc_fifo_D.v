...
//
// Library:
// Filename:ipm_distributed_fifo_v1_4_ov5640_cdc_fifo_D.v
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

`timescale 1 ns / 1 ps

module ipm_distributed_fifo_v1_4_ov5640_cdc_fifo_D
 #(
...
//instance sdpram
ipm_distributed_sdpram_v1_3_ov5640_cdc_fifo_D
#(
 .ADDR_WIDTH(ADDR_WIDTH )  ,    //address width   range:4-10
 .DATA_WIDTH(DATA_WIDTH )  ,    //data width      range:4-256
 .RST_TYPE  (RST_TYPE   )  ,    //reset type   "ASYNC_RESET" "SYNC_RESET"
 .OUT_REG   (OUT_REG    )
 ) ipm_distributed_sdpram_ov5640_cdc_fifo_D
 (
  .wr_data  (wr_data    )  ,
  .wr_addr  (wr_addr    )  ,
  .rd_addr  (rd_addr    )  ,
...
ipm_distributed_fifo_ctr_v1_1_ov5640_cdc_fifo_D
 #(
...
)u_ipm_distributed_fifo_ctr_ov5640_cdc_fifo_D
(
