...
module ips2l_pcie_dma_tx_top #(
    ...
    output wire                         o_mwr_tx_busy           , // [新增] 导出给 Controller 的忙碌标志
    output  wire                        o_mrd_rx_busy           ,  // [新增] RX 忙信号
    // [新增] 外部数据就绪信号
    input                               i_data_ready            ,
    //**********************************************************************
...
assign o_mwr_tx_busy = mwr_tx_busy; // [新增]
