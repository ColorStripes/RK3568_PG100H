...
////////////////////////////数据延迟/////////////////////////////////////////
    ...
    always @(posedge clk) begin
        if(rst) begin
            for (k = 0; k < SCALE_DELAY; k = k + 1) begin
                scale_d[0][k] <= 0;
            end
        end
        else begin
            ...
            for (k = 1; k < SCALE_DELAY; k = k + 1) begin
                scale_d[0][k] <= scale_d[0][k-1];
            end
        end
    end
    ...
    always @(posedge clk) begin
        if(rst) begin
            for (k = 0; k < SCALE_3_DELAY; k = k + 1) begin
                scale_3_d[k] <= 0;
            end
        end
        else begin
            scale_3_d[0] <= scale_3;
            for (k = 1; k < SCALE_3_DELAY; k = k + 1) begin
                scale_3_d[k] <= scale_3_d[k-1];
            end
        end
    end
...
///////////////////////////////////////////数据反量化   MUL_DELAY周期//////////////////////////////////////////////////////
    ...
    generate
        for (i = 0; i < CHA_PAR_IN; i = i + 1) begin: SCALE_S1_AND_S2
            scale_mul_unsign #(
                .DATA_WIDTH(INT),
...
/////////////////////////////////////////重新量化 数据3    MUL_DELAY周期//////////////////////////////////////
    ...
    generate
        for (i = 0; i < CHA_PAR_IN; i = i + 1) begin: SCALE_S3
            scale_mul_unsign_s3 #(
