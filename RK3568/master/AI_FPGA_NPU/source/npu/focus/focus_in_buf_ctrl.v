...
(
    ...
    input  [LEN_WIDTH : 0]               in_col_channel_num ,//这是需要读取一行的总字节数 in_col_channel_num  = col * channel
    ...
    always @(posedge clk ) begin
        ...
        else if(s_last & s_valid & s_ready) begin
            row_cnt <= row_cnt + 1;
        end
    end
    ...
    always @(posedge clk ) begin
        ...
        else if(s_last & s_valid & s_ready & w_double) begin
            w_ctl <= !w_ctl; 
        end
    end
