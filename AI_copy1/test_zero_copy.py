...
FONT_PATH = '/userdata/linaro_workspace/SimHei.ttf'
CONF_THRESH = 0.4
                ...
                if crop_count > 0:
                    ...
                    while processed_num < crop_count:
                        ...
                        if remain_num >= 3:
                            ...
                            rec_out = rknn_rec_b1.inference(inputs=[img])
...
def main():
    ...
    if hw_lib.init_hardware_pipeline() != 0:
        print("硬件初始化失败！")
        return
    DET_MODEL_PATH = '/userdata/linaro_workspace/rknn/INT8_single_plate_640_0.5.rknn'
    REC_MODEL_B4_PATH = '/userdata/linaro_workspace/rknn/LPRNet_multi_300k_b4.rknn'  
    REC_MODEL_B1_PATH = '/userdata/linaro_workspace/rknn/LPRNet_color_300k.rknn' 
    rknn_det = RKNNLite()
